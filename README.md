...
staged - файл попал в список файлов, которые войдут в коммит.
modified - текущая версия файла не совпадает с уже предыдущей.
Файл можеть быть одновременно в нескольких состояниях.
